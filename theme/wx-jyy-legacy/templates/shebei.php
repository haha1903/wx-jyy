...
<div id="contents1">
    ...
    <ul>
        <li>
            <div class="desc">美国原装进口 哈斯VF-2<br><img src="<?= $t ?>/image/shebei/shebei1.jpg" alt="设备1"></div>
            <div class="img">LG MAZAK 200-IIL<br><img src="<?= $t ?>/image/shebei/shebei2.jpg" alt="设备2"></div>
        </li>
        <li>
            <div class="desc">MITUTOYO光学内视镜（合作企业）<br><img src="<?= $t ?>/image/shebei/shebei3.jpg" alt="设备1"></div>
            <div class="img">MITUTOYO 三次元测定器（合作企业）<br><img src="<?= $t ?>/image/shebei/shebei5.jpg" alt="设备2"></div>
        </li>
    </ul>
