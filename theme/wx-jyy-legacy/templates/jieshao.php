...
<div id="contents1">
    ...
    <div id="main">
        ...
        <div class="box">
            <p class="s13a">
                无锡佳与阳精密机械有限公司是国内少有的以专业工程塑料切削加工为主的企业。本公司与日本知名企业技术合作，生产汽车、电子电器设备、医疗设备、通信设备等工程塑料部品的切削加工，及半导体、液晶等制造装置的药液、纯水供给用树脂空气压阀门的设计加工。<br><br>
            </p>
            <p class="s13a">
                本公司融合日本的先端技术和管理方式，引进原装进口数控设备和检测设备，在与日本同等的加工恒温环境下，保证产品质量，从单件试样到批量生产及纳期上都能满足客户要求。<br><br>
            </p>
            <p class="s13a">
                本公司主要使用素材有POM聚甲醛；PP聚丙烯；PVC聚氯乙烯；UPE超高分子聚乙烯；PC聚碳酸酯；PTFE聚四氟乙烯；PEEK聚醚醚酮；PPS聚苯硫醚，MC尼龙等(国内和进口材料齐全)。<br><br>
            </p>
        ...
        <div class="box">
            <div class="left">
                <p class="s13a padding">
                    佳与阳与日本<a href="http://www.kushida-industry.co.jp" target="_blank" rel="noopener">櫛田工業(株)工程塑料专业公司</a>技术合作。
                </p>
            </div>
